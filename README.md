...
Hey, I'm Stephen — a software engineer and content creator from New Jersey. Welcome to my GitHub!

I have 7 years of experience building high-performance, responsive applications. I specialize in scalable backends, developer tools, and digital experiences that drive real impact.

## 🧰 Skills and Tools

- **Languages**: TypeScript, Java, Python, JavaScript, C++, PHP  
...
- **CUNY Brooklyn College**, New York, NY (Aug 2017 – Jan 2023)  
_Bachelor of Science in Computer Science_  
  - Graduated **Cum Laude**  
  - Dean’s Honors List (2017, 2019, 2020, 2023)  
  <!-- - Built `findDining`: a full-stack campus food finder web app (Node.js, Express.js, MongoDB, EJS)   -->
  <!-- - Created `Wintake`: an Android app for tracking water intake (Java, Firebase) -->
- **CUNY Queensborough Community College**, New York, NY (Dec 2021 – Aug 2022)  
_CEWD, Information Technology_  
  - Google-sponsored IT track  
  - Earned multiple certificates in entry-level IT support
- **CUNY Baruch College**, New York, NY (Aug 2016 – Dec 2016)  
...
<!-- - [**tinytrail.co**](https://tinytyrail.co/): A modern, privacy-focused URL shortener built as a portfolio project.
...
[![Python Progrmaming MOOC 2026 - Part 5.4.1 Tuples](https://ytcards.demolab.com/?id=pXxu_bgaMeM&title=Python+Progrmaming+MOOC+2026+-+Part+5.4.1+Tuples&lang=en&timestamp=1784563228&background_color=%230d1117&title_color=%23ffffff&stats_color=%23dedede&max_title_lines=1&width=250&border_radius=5 "Python Progrmaming MOOC 2026 - Part 5.4.1 Tuples")](https://www.youtube.com/watch?v=pXxu_bgaMeM)
[![Python Programming MOOC 2026 - Part 5.3.3 Lists and Dictionaries](https://ytcards.demolab.com/?id=tURuKo_dHvM&title=Python+Programming+MOOC+2026+-+Part+5.3.3+Lists+and+Dictionaries&lang=en&timestamp=1784232030&background_color=%230d1117&title_color=%23ffffff&stats_color=%23dedede&max_title_lines=1&width=250&border_radius=5 "Python Programming MOOC 2026 - Part 5.3.3 Lists and Dictionaries")](https://www.youtube.com/watch?v=tURuKo_dHvM)
[![Python Programming MOOC 2026 - Part 5.3.2 Removing Values from Dictionaries](https://ytcards.demolab.com/?id=zKT8rMvwYwA&title=Python+Programming+MOOC+2026+-+Part+5.3.2+Removing+Values+from+Dictionaries&lang=en&timestamp=1784228420&background_color=%230d1117&title_color=%23ffffff&stats_color=%23dedede&max_title_lines=1&width=250&border_radius=5 "Python Programming MOOC 2026 - Part 5.3.2 Removing Values from Dictionaries")](https://www.youtube.com/watch?v=zKT8rMvwYwA)
[![Python Programming MOOC 2026 - Part 5.3.1 Dictionary](https://ytcards.demolab.com/?id=u795sO-wRWM&title=Python+Programming+MOOC+2026+-+Part+5.3.1+Dictionary&lang=en&timestamp=1783962016&background_color=%230d1117&title_color=%23ffffff&stats_color=%23dedede&max_title_lines=1&width=250&border_radius=5 "Python Programming MOOC 2026 - Part 5.3.1 Dictionary")](https://www.youtube.com/watch?v=u795sO-wRWM)
[![Python Programming MOOC 2026 - Part 5.2.2 More Sudoku and Matrices](https://ytcards.demolab.com/?id=3cwzxsWtmlA&title=Python+Programming+MOOC+2026+-+Part+5.2.2+More+Sudoku+and+Matrices&lang=en&timestamp=1783710045&background_color=%230d1117&title_color=%23ffffff&stats_color=%23dedede&max_title_lines=1&width=250&border_radius=5 "Python Programming MOOC 2026 - Part 5.2.2 More Sudoku and Matrices")](https://www.youtube.com/watch?v=3cwzxsWtmlA)
<!-- END YOUTUBE-CARDS -->
